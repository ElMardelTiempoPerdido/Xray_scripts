...
def main():
    ...
    for i in total:
        ...
        #写入xls
        workbook = xlrd.open_workbook('pelvis.xls')  # 打开工作簿
        ...
        new_worksheet.write(count, 0, i[0])
        new_worksheet.write(count, 1, ss)
        new_worksheet.write(count, 2, pt)
        new_worksheet.write(count, 3, pi)
        new_workbook.save('pelvis.xls')
        count+=1
