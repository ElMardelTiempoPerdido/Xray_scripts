...
def vis_pelvis():
    ...
    # 这是输出绘制了参数的图像的路径
    outpath = r'D:\pyth\xray_preprocess_collection\res_img'
    ...
    for i in total:
        ...
        # 在图片上绘制文字
        if img.shape[1] < 3000:
            cv2.putText(img, 'SS=' + str(ss), (w, h), cv2.FONT_ITALIC, 4.0, (255, 255, 255), 8)
            cv2.putText(img, 'PT=' + str(pt), (w, h + 300), cv2.FONT_ITALIC, 4.0, (255, 255, 255), 8)
            cv2.putText(img, 'PI=' + str(pi), (w, h + 600), cv2.FONT_ITALIC, 4.0, (255, 255, 255), 8)
        else:
            cv2.putText(img, 'SS=' + str(ss), (w, h), cv2.FONT_ITALIC, 8.0, (255, 255, 255), 8)
            cv2.putText(img, 'PT=' + str(pt), (w, h + 300), cv2.FONT_ITALIC, 8.0, (255, 255, 255), 8)
            cv2.putText(img, 'PI=' + str(pi), (w, h + 600), cv2.FONT_ITALIC, 8.0, (255, 255, 255), 8)
        # 骶骨上缘两端点
        cv2.circle(img, p0, 15, (0, 0, 255), 15)
        cv2.circle(img, p1, 15, (0, 0, 255), 15)
        # 骶骨上缘中点
        cv2.circle(img, p2, 15, (0, 0, 255), 15)
        # 股骨连线中点
        cv2.circle(img, p3, 15, (0, 0, 255), 15)
        # 两个股骨中心
        cv2.circle(img, p4, 15, (0, 0, 255), 15)
        cv2.circle(img, p5, 15, (0, 0, 255), 15)
